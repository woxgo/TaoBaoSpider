...
from TaoBaoSpider.utils import create_chrome_driver, add_cookies
...
class TaobaospiderDownloaderMiddleware:
    ...
    def __init__(self):  # 初始化数据管道时模拟用户登录
        ...
        add_cookies(self.browser, '/Users/pengyang/Desktop/WorkSpace/TaoBaoSpider/TaoBaoSpider/taobao2.json')
